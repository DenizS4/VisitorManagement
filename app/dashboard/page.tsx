      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 overflow-auto">
          <div className="p-4 md:p-8 space-y-6">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Pano</h1>
              <p className="text-muted-foreground">Hoş geldiniz, {guard?.first_name || "Görevli"}</p>
            </div>
            <VisitStats guardId={user.id} />
            <RecentVisits guardId={user.id} />
          </div>
        </main>
      </div>
    </div>
